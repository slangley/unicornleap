...
#import "TinyUnicornViewController.h"
#import <CoreGraphics/CoreGraphics.h>
#import <QuartzCore/QuartzCore.h>
#define kUnicornTouchBarCustomization @"com.popcornlabs.unicorn.touchBarCustomization";

NSTouchBarItemIdentifier kUnicornTouchBarUnicornIdentifier =  @"com.popcornlabs.unicorn.unicornView";

@interface TinyUnicornViewController ()
...
@implementation TinyUnicornViewController
...
-(CGMutablePathRef) pathInFrame:(CGRect) screen forSize:(CGSize) size {
    ...
    CGPoint origin = CGPointMake(0, 15);
    CGPathMoveToPoint(path, NULL, origin.x, 15);
    
    CGPathAddLineToPoint(path, NULL, 1100, 15);
...
-(void)viewDidAppear {
    ...
    // Gather image paths
    NSString *imagePath = [[NSBundle mainBundle] pathForResource:@"babyUnicorn" ofType:@"png"];
...
-(NSTouchBarItem *)touchBar:(NSTouchBar *)touchBar makeItemForIdentifier:(NSTouchBarItemIdentifier)identifier {
    ...
    NSCustomTouchBarItem* touchBarItem = [[NSCustomTouchBarItem alloc] initWithIdentifier:kUnicornTouchBarUnicornIdentifier];
    
    NSView* aView = [[NSView alloc] init];
    aView.wantsLayer = YES;
    
    touchBarItem.view = aView;
...
- (nullable NSTouchBar *)makeTouchBar  {
    ...
    self.touchBar.customizationIdentifier = kUnicornTouchBarCustomization;
    self.touchBar.defaultItemIdentifiers = @[kUnicornTouchBarUnicornIdentifier];
